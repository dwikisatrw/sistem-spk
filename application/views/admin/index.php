            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card border-left-dark shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="<?= base_url('Perhitungan/hasil_sementara'); ?>" class="text-secondary text-decoration-none">Data Hasil Sementara</a></div>
                            </div>
                            <div class="col-auto">
