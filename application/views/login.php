...
<body class="bg-gradient-danger">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
        ...
        <div class="container">
            ...
            <a class="navbar-brand text-danger d-flex align-items-center"
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                    <div class="text-justify card-body p-0">
                        <h4 style="font-weight: 800;">Sistem Pendukung Keputusan Penerimaan Karyawan Metode SWARA Kombinasi SMART Pada PT Radhika Patangga Jagaditha
                            </p>
                        </h4>
                        <p>
                            Sistem ini dirancang untuk membantu proses seleksi calon karyawan secara objektif, cepat, dan terstruktur. Sistem ini menggunakan metode SWARA untuk menentukan bobot kepentingan setiap kriteria, serta metode SMART untuk melakukan perhitungan dan perangkingan kandidat berdasarkan nilai yang diperoleh. Dengan adanya sistem ini, proses pengambilan keputusan dalam penerimaan karyawan menjadi lebih efektif, transparan, dan mampu menghasilkan rekomendasi kandidat terbaik sesuai kebutuhan perusahaan.
                        </p>
                    </div>
                </div>
            </div>
