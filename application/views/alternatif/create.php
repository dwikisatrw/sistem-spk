...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-danger">
			<i class="fas fa-fw fa-plus"></i> Tambah Data Calon Karyawan (Alternatif)
		</h6>
	</div>

	<!-- UBAH MENJADI multipart -->
	...
	<div class="card-body">
		<div class="row">
			...
			<div class="form-group col-md-12">
				<label class="font-weight-bold">Nama Calon Karyawan (Alternatif)</label>
				<input autocomplete="off" type="text" name="nama" required class="form-control" />
			</div>

			<div class="form-group col-md-12">
				<label class="font-weight-bold">Nomor Telepon</label>
				<input autocomplete="off" type="number" name="telepon" required class="form-control" />
			</div>
