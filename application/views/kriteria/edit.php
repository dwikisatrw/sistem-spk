	...
	<?php echo form_open('Kriteria/update/'.$kriteria->id_kriteria); ?>
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					<label class="font-weight-bold">Bobot Kriteria Awal</label>
					<input autocomplete="off" type="number" name="bobot_awal" step="0.01" value="<?php echo $kriteria->bobot_awal ?>" required class="form-control"/>
				</div>
