				...
				<?= form_open('Sub_kriteria/store') ?>
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input autocomplete="off" type="number" step="0.01" id="nilai" name="nilai" class="form-control" required>
						</div>
					</div>
							...
							<div class="modal-content">
								...
								<?= form_open('Sub_kriteria/update/'.$key['id_sub_kriteria']) ?>
									...
									<div class="modal-body">
										...
										<div class="form-group">
											<label for="nilai" class="font-weight-bold">Nilai</label>
											<input type="number" step="0.01" autocomplete="off" id="nilai" name="nilai" class="form-control" value="<?= $key['nilai'] ?>" required>
										</div>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-warning" data-dismiss="modal"><i class="fa fa-times"></i> Batal</button>
