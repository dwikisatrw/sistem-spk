<?php
    ...
    class Kriteria extends CI_Controller {
        ...
        public function store()
        {
			...
			$this->form_validation->set_rules('bobot_awal', 'Bobot', 'required');
		...
		public function swara()
        {
            $data['page'] = "Kriteria";
			$data['list'] = $this->Kriteria_model->get_kriteria_order();
            $this->load->view('kriteria/swara', $data);
        }
